...
export const longestOperatorLength = operators.reduce(function(length, item) {
...
export const isDigit = (char) => RE_DIGIT.test(char)

export const isOperatorStart = (char) =>  RE_OPERATOR_START.test(char)

export const isParen = (char) => RE_PAREN.test(char)

export const isWhitespace = (char) => RE_WHITESPACE.test(char)

export const isDot = (value) => value === '.'

export const isOperator = str => operators.includes(str)

export const RE_DIGIT = /[0-9]/
export const RE_PAREN = /[()]/
export const RE_WHITESPACE = /\s/
export const RE_OPERATOR_START = new RegExp(
...
export const RE_OPERATOR_WHOLE = new RegExp(
